...
python ./test-weightedCAM.py --image_size="200,200" --image_channel=3 --image_dir='./data/tumor' --dataname='tumor' --targetname='radius' --save_name='./result-model/tumor/lr0.01-b10.9-b20.999seed0/PaIRNet-self-supervised/best.pth'
