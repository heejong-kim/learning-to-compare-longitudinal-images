...
python ./train-baseline-crosssectional-regression.py --max_epoch=1 --num_workers=1 --image_size="200,200" --image_channel=3 --targetname='size' --image_dir='./data/tumor' --dataname='tumor'
